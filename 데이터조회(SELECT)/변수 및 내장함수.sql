...
SELECT format(100000000.24235463, 2);
...
SELECT ceil(23.4), floor(23.4), round(23.4);
...
-- ADDDATE(날짜, 차이) : 날짜를 더한 날짜를 반환
SELECT adddate(now(), INTERVAL 100 DAY);	-- 오늘부터 100일 더한 날짜
SELECT subdate(now(), INTERVAL 100 DAY);	-- 오늘부터 100일 뺸 날짜
